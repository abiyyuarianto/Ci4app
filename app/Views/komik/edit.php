...
<div class="container">
    <div class="row">
        <div class="col-8">
            <h1 class="h3 text-gray-800">Form Edit Data Komik </h1>
            <form action="/komik/update/<?= $komik['id']; ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <input type="hidden" name="slug" id="" value="<?= $komik['slug']; ?>">
                <input type="hidden" name="sampulLama" value="<?= $komik['sampul']; ?>" id="">
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group mb-3">
                            ...
                            <label class="input-group-text file-label" for="sampul"><?= $komik['sampul']; ?></label>
                            <div class="invalid-feedback">
